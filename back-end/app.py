...
def initt():
    ...
    additional_tags = [
        ...
        ['여행스타그램', '여행', 'travel', '일상', '데일리',
            'daily', '감성', '인스타감성', '맞팔', '선팔'],
        ['셀피', '셀카', '셀스타그램', 'selfie', '일상', '데일리',
            'daily', '감성', '인스타감성', '맞팔', '선팔'],
        ['육아스타그램', '도치맘', '육아기록', '육아소통', '베이비스타그램',
            '인스타베이비', '감성', '인스타감성', '맞팔', '선팔'],
        ['신나는파티', '일상', '데일리', 'daily', '감성', '인스타감성', '맞팔', '선팔'],
        ['집스타그램', '일상', '데일리', 'daily', '하우스그램', '감성', '인스타감성', '맞팔', '선팔'],
        ['공부', '공스타', '일상', '데일리', 'daily', '동기부여', '공부기록',
            '공스타맞팔', '필기', '감성', '인스타감성', '맞팔', '선팔'],
        ['호텔', '또가고싶다', '휴가', '여행', '일상', '데일리',
            'daily', '감성', '인스타감성', '맞팔', '선팔'],
        ['캣스타그램', '냥스타', '고양이', 'cat', '일상', '데일리', 'daily', '집사의하루',
            '냥이', '야옹이', '집사', '캣스타', '감성', '인스타감성', '맞팔', '선팔'],
        ['풍경', '풍경사진', '야경맛집', '야경사진', '경치', '일상',
            '데일리', 'daily', '감성', '인스타감성', '맞팔', '선팔'],
        ['데이트스타그램', '럽스타그램', '커플', '럽스타', '커플스타그램', '감성', '인스타감성', '맞팔', '선팔'],
        ['셀피', '얼스타그램', 'selfie', '셀스타그램', '데일리', '일상',
            'daily', '선팔', '맞팔', '소통', 'selstagram'],
        ['dailylook', '코디', '데일리코디', '옷스타그램', '데일리룩코디', '오늘의코디',
            '패션', '일상', '데일리', 'daily', '감성', '인스타감성', '맞팔', '선팔'],
        ['운동스타그램', '운동그램', '헬창', '헬스타그램', '헬스스타그램', '데일리',
            '일상', 'daily', '감성', '인스타감성', '맞팔', '선팔'],
...
def faces():
    ...
    try:
        for top, right, bottom, left in face_location:
            ...
            result.append({'x': int(left), 'y': int(top), 'width': int(
                right-left), 'height': int(bottom - top), 'base64': encoded_face})
    except:
...
def get_tags():
    ...
    image_for_tag = cv2.resize(
        image_for_tag, (128, 128), interpolation=cv2.INTER_LINEAR)
